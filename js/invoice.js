  ...
  <!--h4 class="status">${status}</h4><br-->
    ...
    <table class="main-cal" id="maincl">
        <tr>
          ...
          <th style="width: 30%; border-bottom: 1px solid #ccc;">Description of Goods</th>
          <th style="border-bottom: 1px solid #ccc;">HSN Code</th>
          <th style="border-bottom: 1px solid #ccc;">GST</th>
          <th style="border-bottom: 1px solid #ccc;">Quantity</th>
          <th style="border-bottom: 1px solid #ccc;">Rate</th>
          <th style="border-bottom: 1px solid #ccc;">Per</th>
